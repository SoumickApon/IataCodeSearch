...
def extract_data_for_country(country_name):
    ...
    try:
        ...
        if iata_values and name_values and city_values and country_values:
            ...
            data = []
            for i in range(len(name_values)):  # Loop through the number of rows
                iata = iata_values[i].text.strip() if i < len(iata_values) else ""  # IATA might be empty
                ...
                if name and city and country:  # Allow IATA to be empty
