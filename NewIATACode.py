...
try:
    ...
    country_name = input("Enter the country name to extract data: ").strip()
    ...
    # Select the input country from the dropdown by visible text
    ...
    if iata_values and name_values and city_values:
        ...
        csv_file = f"{country_name.lower().replace(' ', '_')}_iata_name_city_data.csv"
